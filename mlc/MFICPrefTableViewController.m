...
#import "MFICControlListTableViewController.h"
@interface MFICPrefTableViewController ()

@end

@implementation MFICPrefTableViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *gpd = [shared controllerPreferences];
        ...
        NSString *value = gpd[key];
         NSLog(@"value: %@", value);
        MFICControlListTableViewController *controller = [[MFICControlListTableViewController alloc] initWithOriginalValue:value keyValue:key];
...
- (void)configureCell:(UITableViewCell *)cell forRow:(NSInteger)row {
    ...
    NSDictionary *gpd = [[MFICControllerManager sharedManager] controllerPreferences];
